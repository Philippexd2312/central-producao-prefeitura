...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  // Sem sessão válida, renderizamos somente a página pública (login).
  // As páginas internas são protegidas pelo middleware e redirecionam para /login.
  if (!current) {
    return (
      <html lang="pt-BR">
        <body className="publicAuthBody">{children}</body>
      </html>
    );
  }
          ...
          <aside className="sidebar">
            ...
            <div className="sidebarFooter">
              ...
              <div>
                ...
                <span>{current.name} conectado</span>
              </div>
            </div>
          </aside>
